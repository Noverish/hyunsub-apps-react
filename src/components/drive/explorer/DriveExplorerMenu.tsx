...
export default function DriveExplorerMenu({ files }: Props) {
  ...
  const selectionMenus = (
    <>
      <div className="vr" />
      <Button variant="primary" onClick={onRename}><i className="fas fa-pen" /></Button>
      <Button variant="primary" onClick={onMove}><i className="fas fa-exchange-alt" /></Button>
      <Button variant="primary" onClick={driveFileDownload}><i className="fas fa-download" /></Button>
      <Button variant="danger" onClick={driveFileRemove}><i className="fas fa-trash" /></Button>
  ...
  return (
    <div className="DriveExplorerMenu">
      <Button onClick={onSquareClick}><i className={squareIcon} /></Button>
      <DriveUploadButton />
      <Button variant="primary" onClick={onRefresh}><i className="fas fa-sync-alt" /></Button>
      <Button variant="primary" onClick={driveNewFolder}><i className="fas fa-folder-plus" /></Button>
